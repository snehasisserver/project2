...
document.getElementById("S_tobe_drawn").innerHTML = "Sketch to be drawn - " + sketch;
...
timer_counter++;
document.getElementById("timer_span").innerHTML =timer_counter;
console.log(timer);
...
function updateCanvas(){
    ...
    document.getElementById("s_tobe_drawn").innerHTML=random_number;
}
function setup(){
